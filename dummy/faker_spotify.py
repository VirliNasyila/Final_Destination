...
if not CLIENT_ID or not CLIENT_SECRET:
    raise ValueError("⚠️ ERROR: Pastikan .env berisi SPOTIFY_CLIENT_ID dan SPOTIFY_CLIENT_SECRET")
...
def generate_data_safe():
    ...
    # --- FETCH SPOTIFY DATA ---
    print("🔎 Mencari data lagu dari Spotify...")
    collected_tracks = []
    attempts = 0
    ...
    print(f"✅ Mendapatkan {len(collected_tracks)} lagu unik.")
    ...
    with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
        f.write("\n".join(sql_statements))
    print(f"🎉 Selesai! File '{OUTPUT_FILE}' siap. Total 27/27 Tabel terisi.")
